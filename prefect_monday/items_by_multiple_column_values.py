"""
This is a module for interacting with Monday Query items_by_multiple_column_values tasks.
...
config_path = (
    ...
    / "configs"
    / "query"
    / "items_by_multiple_column_values.json"
)
...
async def query_items_by_multiple_column_values(
    ...
    op_settings = op.items_by_multiple_column_values(
        **strip_kwargs(
            board_id=board_id,
            column_id=column_id,
