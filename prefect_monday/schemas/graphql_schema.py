...
class AccountProductKind(sgqlc.types.Enum):
    ...
    __choices__ = ('core', 'crm', 'forms', 'marketing', 'projectManagement', 'software', 'whiteboard')
...
class ColumnType(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('auto_number', 'checkbox', 'color_picker', 'country', 'creation_log', 'date', 'dependency', 'dropdown', 'email', 'file', 'hour', 'integration', 'item_id', 'last_updated', 'link', 'location', 'long_text', 'numbers', 'people', 'phone', 'progress', 'rating', 'status', 'tags', 'team', 'text', 'time_tracking', 'timeline', 'vote', 'week', 'world_clock')
...
class WebhookEventType(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('change_column_value', 'change_name', 'change_specific_column_value', 'change_status_column_value', 'change_subitem_column_value', 'change_subitem_name', 'create_item', 'create_subitem', 'create_subitem_update', 'create_update', 'item_archived', 'item_deleted', 'subitem_archived', 'subitem_deleted', 'when_date_arrived')
...
class Account(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('first_day_of_the_week', 'id', 'logo', 'name', 'plan', 'show_timeline_weekends', 'sign_up_product_kind', 'slug', 'tier')
...
class AppSubscription(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('billing_period', 'days_left', 'is_trial', 'plan_id', 'renewal_date')
...
class Board(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('activity_logs', 'board_folder_id', 'board_kind', 'columns', 'communication', 'creator', 'description', 'groups', 'id', 'items', 'name', 'owner', 'owners', 'permissions', 'pos', 'state', 'subscribers', 'tags', 'top_group', 'type', 'updated_at', 'updates', 'views', 'workspace', 'workspace_id')
...
class Column(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('archived', 'description', 'id', 'pos', 'settings_str', 'title', 'type', 'width')
...
class ColumnValue(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('additional_info', 'description', 'id', 'text', 'title', 'type', 'value')
...
class Item(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('assets', 'board', 'column_values', 'created_at', 'creator', 'creator_id', 'email', 'group', 'id', 'name', 'parent_item', 'state', 'subitems', 'subscribers', 'updated_at', 'updates')
...
class Mutation(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('add_file_to_column', 'add_file_to_update', 'add_subscribers_to_board', 'add_teams_to_workspace', 'add_users_to_workspace', 'archive_board', 'archive_group', 'archive_item', 'change_column_metadata', 'change_column_title', 'change_column_value', 'change_multiple_column_values', 'change_simple_column_value', 'clear_item_updates', 'complexity', 'create_board', 'create_column', 'create_group', 'create_item', 'create_notification', 'create_or_get_tag', 'create_subitem', 'create_update', 'create_webhook', 'create_workspace', 'delete_board', 'delete_group', 'delete_item', 'delete_subscribers_from_board', 'delete_teams_from_workspace', 'delete_update', 'delete_users_from_workspace', 'delete_webhook', 'duplicate_board', 'duplicate_group', 'duplicate_item', 'like_update', 'move_item_to_group', 'remove_mock_app_subscription', 'set_mock_app_subscription', 'update_board')
    ...
    add_teams_to_workspace = sgqlc.types.Field(sgqlc.types.list_of('Team'), graphql_name='add_teams_to_workspace', args=sgqlc.types.ArgDict((
        ('workspace_id', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='workspace_id', default=None)),
        ('team_ids', sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(Int)), graphql_name='team_ids', default=None)),
))
    )
    ...
    create_board = sgqlc.types.Field(Board, graphql_name='create_board', args=sgqlc.types.ArgDict((
        ...
        ('folder_id', sgqlc.types.Arg(Int, graphql_name='folder_id', default=None)),
        ('workspace_id', sgqlc.types.Arg(Int, graphql_name='workspace_id', default=None)),
    ...
    create_update = sgqlc.types.Field('Update', graphql_name='create_update', args=sgqlc.types.ArgDict((
        ...
        ('item_id', sgqlc.types.Arg(Int, graphql_name='item_id', default=None)),
        ('parent_id', sgqlc.types.Arg(Int, graphql_name='parent_id', default=None)),
))
    )
    ...
    like_update = sgqlc.types.Field('Update', graphql_name='like_update', args=sgqlc.types.ArgDict((
        ('update_id', sgqlc.types.Arg(Int, graphql_name='update_id', default=None)),
))
    )
    ...
    remove_mock_app_subscription = sgqlc.types.Field(AppSubscription, graphql_name='remove_mock_app_subscription', args=sgqlc.types.ArgDict((
        ('app_id', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='app_id', default=None)),
...
class Query(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('account', 'app_subscription', 'apps_monetization_status', 'assets', 'boards', 'complexity', 'items', 'items_by_column_values', 'items_by_multiple_column_values', 'me', 'tags', 'teams', 'updates', 'users', 'webhooks')
    ...
    items_by_multiple_column_values = sgqlc.types.Field(sgqlc.types.list_of(Item), graphql_name='items_by_multiple_column_values', args=sgqlc.types.ArgDict((
        ('limit', sgqlc.types.Arg(Int, graphql_name='limit', default=None)),
        ('page', sgqlc.types.Arg(Int, graphql_name='page', default=1)),
        ('board_id', sgqlc.types.Arg(sgqlc.types.non_null(Int), graphql_name='board_id', default=None)),
        ('column_id', sgqlc.types.Arg(sgqlc.types.non_null(String), graphql_name='column_id', default=None)),
        ('column_values', sgqlc.types.Arg(sgqlc.types.non_null(sgqlc.types.list_of(String)), graphql_name='column_values', default=None)),
        ('column_type', sgqlc.types.Arg(String, graphql_name='column_type', default=None)),
        ('state', sgqlc.types.Arg(State, graphql_name='state', default='active')),
))
    )
