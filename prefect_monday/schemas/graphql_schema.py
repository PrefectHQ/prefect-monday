...
class BoardAttributes(sgqlc.types.Enum):
    __schema__ = graphql_schema
    __choices__ = ('communication', 'description')
...
class Board(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('activity_logs', 'board_folder_id', 'board_kind', 'columns', 'communication', 'creator', 'description', 'groups', 'id', 'items', 'name', 'owner', 'owners', 'permissions', 'pos', 'state', 'subscribers', 'tags', 'top_group', 'updated_at', 'updates', 'views', 'workspace', 'workspace_id')
...
class Item(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('assets', 'board', 'column_values', 'created_at', 'creator', 'creator_id', 'group', 'id', 'name', 'parent_item', 'state', 'subitems', 'subscribers', 'updated_at', 'updates')
...
class Query(sgqlc.types.Type):
    __schema__ = graphql_schema
    __field_names__ = ('account', 'app_subscription', 'apps_monetization_status', 'assets', 'boards', 'complexity', 'items', 'items_by_column_values', 'items_by_multiple_column_values', 'me', 'tags', 'teams', 'updates', 'users')
